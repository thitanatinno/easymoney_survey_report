/**
 * Normalizes a Kobo submission into structured sections
 * Outputs: { meta, general, building, routeline, combiner, customerMDP, attachmentMaps }
 * 
 * @param {Object} submission - Raw submission from Kobo API
 * @returns {Object} - Normalized data structure
 */
export function normalizeSubmission(submission) {
  console.log('\n🔄 NORMALIZING SUBMISSION...');
  ...
  // Store raw attachments for later mapping
